...
import { Phone, Lock, User, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#080808] flex items-center justify-center px-6 relative overflow-hidden" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full max-w-sm relative z-10">
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700, color: '#fff', letterSpacing: '-0.04em', textAlign: 'center', marginBottom: 6 }}>Create your account</h1>
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.38)', textAlign: 'center', marginBottom: 28 }}>Free to start — no card required</p>
        ...
        <div style={{ background: '#141414', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: 24 }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#1c1c1e', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '11px 14px' }}>
              <User size={15} color="rgba(255,255,255,0.28)" />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#1c1c1e', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '11px 14px' }}>
              ...
              <input type="tel" placeholder="Phone number" value={phone} onChange={e => setPhone(e.target.value)} required autoFocus
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontSize: 13, fontFamily: 'inherit' }} />
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#1c1c1e', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '11px 14px' }}>
              ...
              <input type={showPass ? 'text' : 'password'} placeholder="Password (6+ characters)" value={password} onChange={e => setPassword(e.target.value)} required
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontSize: 13, fontFamily: 'inherit' }} />
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: 'rgba(255,255,255,0.3)', marginTop: 20 }}>
          ...
          <Link href="/login" style={{ color: '#9d95ff', textDecoration: 'none' }}>Sign in</Link>
        </p>
      </motion.div>
